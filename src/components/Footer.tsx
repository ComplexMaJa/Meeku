            ...
            <div className="container">
                <div className="footer__inner">
                    ...
                    <div className="footer__brand">
                        <img src={logoImg} alt="MEEKU Logo" className="footer__logo" />
                        <span className="footer__brand-name">MEEKU</span>
                    </div>

                    {/* Navigation */}
                    <nav className="footer__nav" id="footer-nav">
                        <Link to="/shop" className="footer__link">Shop</Link>
                        <button type="button" className="footer__link" onClick={() => handleSectionNav('editorial')}>Collection</button>
                        <button type="button" className="footer__link" onClick={() => handleSectionNav('about')}>About</button>
                        <button type="button" className="footer__link" onClick={() => handleSectionNav('newsletter')}>Contact</button>
                    </nav>
                    ...
                    <div className="footer__social" id="footer-social">
                        ...
                        <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="Twitter/X">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M4 4l11.733 16h4.267l-11.733-16zM4 20l6.768-6.768M13.232 10.768L20 4"></path>
                            </svg>
                        </a>
                    ...
                    <p className="footer__copyright">
                        © 2026 MEEKU. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
